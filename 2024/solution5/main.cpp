...
int main() {
    std::cout << star1(aoc_utils::EXAMPLE_INPUT_FILE) << std::endl; // 143
    std::cout << star1(aoc_utils::INPUT_FILE) << std::endl; // 4185
    std::cout << star2(aoc_utils::EXAMPLE_INPUT_FILE) << std::endl; // 123
    std::cout << star2(aoc_utils::INPUT_FILE) << std::endl; // 4480
    return 0;
}
